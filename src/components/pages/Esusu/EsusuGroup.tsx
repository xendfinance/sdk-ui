    ...
    return (
        <Container>
            ...
            <Box className='group-action' mt={3}>
                <Box className='h1'>My Esusu Groups</Box>
                <Box className='sunset-contained create-esusu'>
                    <Button className='h3' onClick={() => handleCreateGroup()}>Create Esusu Group</Button>
                </Box>
            </Box>
            ...
            <ModalEsusuNewGroup open={open} setOpen={setOpen} init={init}/>
            <Box p={9}></Box>
        </Container>
    )
}

export default EsusuGroup;
